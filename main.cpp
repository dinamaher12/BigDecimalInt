...
using namespace std;
int main(){
BigDecimalInt num1 ("0"); //123456789012345678901234567890
BigDecimalInt num2 ("-83"); //+113456789011345678901134567890
BigDecimalInt num3 ("200000000000000000000000000000");
BigDecimalInt num8 (3568844654648788);
BigDecimalInt num9 ("100000000000000000000000000");
BigDecimalInt num10 ("5555555555555555555555555");
